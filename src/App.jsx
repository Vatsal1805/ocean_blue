...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-brand-primaryBg text-brand-charcoal w-full overflow-x-clip selection:bg-brand-navy selection:text-brand-white">
      ...
      {/* Animated pulsing WhatsApp Floating CTA Button */}
      <motion.a
        href="https://wa.me/919033552048"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-[999] w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center text-white shadow-xl cursor-pointer group select-none"
        animate={{
          boxShadow: [
      ...
      >
        {/* Tooltip on Hover */}
        <span className="absolute right-16 bg-white border border-[#dddbd4] text-[#1a1a1a] font-sans font-light text-[12px] px-3 py-1.5 rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity duration-200 select-none whitespace-nowrap shadow-sm">
          Chat with us
        </span>
